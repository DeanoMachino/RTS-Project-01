...
/// ================
/// PlannedObject.cs
/// Class detailed an object in the world which has been planned

using UnityEngine;
using System.Collections;

public class PlannedObject : MonoBehaviour {
    /// Variables
    ...
    public void Initialise(World world_, Tile tile_) {
        ...
        gameObject.GetComponent<Renderer>().material.color = new Color(0f, 0.7f, 0f, 0.5f);
    }
	...
	void Update () {
        if (tile.changed) {
            if (tile.plannedObjectType == ObjectType.None) {
                Destroy(gameObject);
            }
        }
	}
